...
const scrapbookText = localStorage.getItem('scrapbookText_typeSizeFunky');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_typeSizeFunky', outputText);
  window.location.href = 'funkyScrapbookTypeSize.html';
});
