...
const scrapbookText = localStorage.getItem('scrapbookText_fullTypeFuturistic');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_fullTypeFuturistic', outputText);
  window.location.href = 'futuristicScrapbookFullType.html';
});
