...
const scrapbookText = localStorage.getItem('scrapbookText_typeSizeOldTimey');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_typeSizeOldTimey', outputText);
  window.location.href = 'oldTimeyScrapbookTypeSize.html';
});
