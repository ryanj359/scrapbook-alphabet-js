...
const scrapbookText = localStorage.getItem('scrapbookText_typeStyleBWFuturistic');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_typeStyleBWFuturistic', outputText);
  window.location.href = 'futuristicScrapbookTypeStyleBW.html';
});
