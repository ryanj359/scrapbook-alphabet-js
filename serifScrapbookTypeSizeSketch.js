...
const scrapbookText = localStorage.getItem('scrapbookText_typeSizeSerif');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_typeSizeSerif', outputText);
  window.location.href = 'serifScrapbookTypeSize.html';
});
