...
const scrapbookText = localStorage.getItem('scrapbookText_typeStyleColorSerif');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_typeStyleColorSerif', outputText);
  window.location.href = 'serifScrapbookTypeStyleColor.html';
});
