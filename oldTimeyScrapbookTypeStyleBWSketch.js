...
const scrapbookText = localStorage.getItem('scrapbookText_typeStyleBWOldTimey');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_typeStyleBWOldTimey', outputText);
  window.location.href = 'oldTimeyScrapbookTypeStyleBW.html';
});
