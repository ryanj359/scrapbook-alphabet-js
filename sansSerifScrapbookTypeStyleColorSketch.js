...
const scrapbookText = localStorage.getItem('scrapbookText_typeStyleColorSansSerif');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_typeStyleColorSansSerif', outputText);
  window.location.href = 'sansSerifScrapbooktypeStyleColor.html';
});
