...
const scrapbookText = localStorage.getItem('scrapbookText_fullTypeSerif');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_fullTypeSerif', outputText);
  window.location.href = 'serifScrapbokFullType.html';
});
