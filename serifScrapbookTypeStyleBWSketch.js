...
const scrapbookText = localStorage.getItem('scrapbookText_typeStyleBWSerif');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_typeStyleBWSerif', outputText);
  window.location.href = 'serifScrapbookTypeStyleBW.html';
});
