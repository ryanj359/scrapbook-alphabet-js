...
const scrapbookText = localStorage.getItem('scrapbookText_typeStyleColorOldTimey');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_typeStyleColorOldTimey', outputText);
  window.location.href = 'oldTimeyScrapbookTypeStyleColor.html';
});
