...
const scrapbookText = localStorage.getItem('scrapbookText_TypeStyleColorFunky');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_TypeStyleColorFunky', outputText);
  window.location.href = 'funkyScrapbookTypeStyleColor.html';
});
