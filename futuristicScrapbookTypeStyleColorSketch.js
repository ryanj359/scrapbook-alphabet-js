...
const scrapbookText = localStorage.getItem('scrapbookText_typeStyleColorFuturistic');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_typeStyleColorFuturistic', outputText);
  window.location.href = 'futuristicScrapbookTypeSize.html';
});
