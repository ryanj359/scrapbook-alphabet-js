...
const scrapbookText = localStorage.getItem('scrapbookText_typeSizeSansSerif');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_typeSizeSansSerif', outputText);
  window.location.href = 'sansSerifScrapbookTypeSize.html';
});
