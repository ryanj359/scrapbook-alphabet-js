...
const scrapbookText = localStorage.getItem('scrapbookText_typeStyleBWSansSerif');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_typeStyleBWSansSerif', outputText);
  window.location.href = 'sansSerifScrapbookTypeStyleBW.html';
});
