...
const scrapbookText = localStorage.getItem('scrapbookText_fullTypeSansSerif');
...
document.getElementById('addToScrapbookBtn').addEventListener('click', function() {
  ...
  localStorage.setItem('scrapbookText_fullTypeSansSerif', outputText);
  window.location.href = 'sansSerifScrapbookFullType.html';
});
